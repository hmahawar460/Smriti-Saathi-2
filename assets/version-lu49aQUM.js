 ...
 * limitations under the License.
 * =============================================================================
 */const Ta=20,Ht=3,Ts=7;function jf(t,e,n,s){const r=Wt(e),a=Mf(t,e,n,r),o=e.length,i=Dn(t,e,n,r,a),u=["Tensor"];return s&&(u.push(`  dtype: ${n}`),u.push(`  rank: ${o}`),u.push(`  shape: [${e}]`),u.push("  values:")),u.push(i.map(c=>"    "+c).join(`
`)),u.join(`
 ...
 * limitations under the License.
 * =============================================================================
 */function bm(t){const n={x:d(t,"x","atanh")};return N.runKernel(Eo,n)}const jc=w({atanh_:bm});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jm(t,e){const n=d(t,"x","bitwiseAnd"),s=d(e,"y","bitwiseAnd");if(!Re(n.shape,s.shape))throw new Error(`BitwiseAnd: Tensors must have the same shape. x: ${n.shape}, y: ${s.shape}`);if(n.dtype!=="int32"||s.dtype!=="int32")throw new Error(`BitwiseAnd: Only supports 'int32' values in tensor, found type of x: ${n.dtype} and type of y: ${s.dtype}`);const r={a:n,b:s};return N.runKernel(Oo,r)}const Zc=w({bitwiseAnd_:jm});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Wm(t,e){let n=d(t,"broadcastTo","x");const s=n.shape;if($e(e),e.length<n.rank)throw new Error(`broadcastTo(): shape.length=${e.length} < input.rank=${n.rank}.`);if(e.length>n.rank){const c=n.shape.slice();for(;c.length<e.length;)c.unshift(1);n=I(n,c)}const r=n.shape,a=Array.from(e);for(let c=e.length-1;c>=0;c--)if(r[c]===e[c])a[c]=1;else if(n.shape[c]!==1)throw new Error(`broadcastTo(): [${s}] cannot be broadcast to [${e}].`);if(a.map((c,h)=>c>1?h:-1).filter(c=>c>=0).length===0)return Ge(n);const i={x:n},u={reps:a};return N.runKernel(dr,i,u)}const Yt=w({broadcastTo_:Wm});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function rg(t){const n={x:d(t,"x","cos","float32")};return N.runKernel(Wo,n)}const cl=w({cos_:rg});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pg(t,e=0){const n=d(t,"x","expandDims","string_or_numeric");g(e<=n.rank,()=>"Axis must be <= rank of the tensor");const s={input:n},r={dim:e};return N.runKernel(ii,s,r)}const Me=w({expandDims_:Pg});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jg(t){const n={x:d(t,"x","floor","float32")};return N.runKernel(pi,n)}const Dr=w({floor_:jg});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Wg(t,e){let n=d(t,"a","greater","string_or_numeric"),s=d(e,"b","greater","string_or_numeric");[n,s]=ee(n,s),re(n.shape,s.shape);const r={a:n,b:s};return N.runKernel(yi,r)}const En=w({greater_:Wg});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function uy(t,e){let n=d(t,"a","sub"),s=d(e,"b","sub");[n,s]=ee(n,s);const r={a:n,b:s};return N.runKernel(qu,r)}const j=w({sub_:uy});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function cy(t,e=-1){const n=d(t,"logits","logSoftmax");if(e===-1&&(e=n.rank-1),e!==n.rank-1)throw Error(`Log Softmax along a non-last dimension is not yet supported. Logits was rank ${n.rank} and axis was ${e}`);return Ve((r,a)=>{const i=Nt(r,e,!0),u=j(r,i),c=j(J(u,"float32"),zt(X(it(u),e,!0)));return a([c]),{value:c,gradFunc:(l,f)=>{const[m]=f,b=!0,T=it(m);return j(l,D(X(l,e,b),T))}}})(n)}const Fl=w({logSoftmax_:cy});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ly(t,e=null,n=!1){const s=d(t,"x","logSumExp"),r=dn(e,s.shape),a=Nt(s,r,!0),o=j(s,a),i=it(o),u=X(i,r),c=zt(u),h=P(I(a,c.shape),c);if(n){const l=Tn(h.shape,r);return I(h,l)}return h}const Br=w({logSumExp_:ly});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Sy(t,e){let n=d(t,"a","minimum"),s=d(e,"b","minimum");[n,s]=ee(n,s),n.dtype==="bool"&&(n=J(n,"int32"),s=J(s,"int32")),re(n.shape,s.shape);const r={a:n,b:s};return N.runKernel(ji,r)}const hn=w({minimum_:Sy});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $y(t,e){let n=d(t,"a","mod"),s=d(e,"b","mod");[n,s]=ee(n,s);const r={a:n,b:s};return N.runKernel(Wi,r)}const Vl=w({mod_:$y});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _y(t,e){let n=d(t,"a","notEqual","string_or_numeric"),s=d(e,"b","notEqual","string_or_numeric");[n,s]=ee(n,s),re(n.shape,s.shape);const r={a:n,b:s};return N.runKernel(Hi,r)}const Wr=w({notEqual_:_y});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Py(t,e,n,s,r,a,o){r==null&&(r=[1,1]),a==null&&(a=1),s===0&&(s="valid");const i=d(t,"x","maxPool");let u=i,c=!1;i.rank===3&&(c=!0,u=I(i,[1,i.shape[0],i.shape[1],i.shape[2]])),g(Xe(a,r),()=>`Error in pool: Either strides or dilations must be 1. Got strides ${a} and dilations '${r}'`);const h=Mc(u.shape,e,a,r,s),l=[h.dilationHeight,h.dilationWidth];let f;s==="same"?f=zy([h.filterHeight,h.filterWidth],l):f=[[0,0],[0,0]];const m=l[0]===1&&l[1]===1,[b,T]=By([h.inHeight,h.inWidth],l,f),S=m?s:"valid",$=m?u:Ur(u,l,b),k=(n==="avg"?()=>Er($,e,a,S,o):()=>jr($,e,a,S,o))(),_=m?k:vr(k,l,T);return c?I(_,[_.shape[1],_.shape[2],_.shape[3]]):_}function By(t,e,n){const s=n.map(h=>h[0]),r=n.map(h=>h[1]),a=t.concat(s,r),o=e.map((h,l)=>(h-a[l]%h)%h),i=r.map((h,l)=>h+o[l]),u=e.map((h,l)=>[s[l],i[l]]),c=e.map((h,l)=>[0,o[l]]);return[u,c]}function zy(t,e){const s=t.map((o,i)=>o+(o-1)*(e[i]-1)).map(o=>o-1),r=s.map(o=>Math.floor(o/2)),a=s.map((o,i)=>o-r[i]);return s.map((o,i)=>[r[i],a[i]])}const Zl=w({pool_:Py});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jy(t,e=null,n=!1){let s=d(t,"x","prod");s.dtype==="bool"&&(s=J(s,"int32"));const r={x:s},a={axis:e,keepDims:n};return N.runKernel(su,r,a)}const Jl=w({prod_:jy});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Wy(t,e,n){const s=d(t,"starts","raggedRange"),r=d(e,"limits","raggedRange",s.dtype),a=d(n,"deltas","raggedRange",s.dtype),o={starts:s,limits:r,deltas:a},i=N.runKernel(au,o);return{rtNestedSplits:i[0],rtDenseValues:i[1]}}const Ql=w({raggedRange_:Wy});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _b(t){const n={input:d(t,"input","real")};return N.runKernel(uu,n)}const jt=w({real_:_b});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jb(t){const n={x:d(t,"x","sign")};return N.runKernel(ku,n)}const gh=w({sign_:jb});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Wb(t){const n={x:d(t,"x","sinh")};return N.runKernel(vu,n)}const bh=w({sinh_:Wb});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qb(t,e){g(t.dtype==="float32",()=>`The dtype for rfft() must be real value but got ${t.dtype}`);let n=t.shape[t.shape.length-1];const s=t.size/n;let r;if(e!=null&&e<n){const b=t.shape.map(S=>0),T=t.shape.map(S=>S);T[t.shape.length-1]=e,r=H(t,b,T),n=e}else if(e!=null&&e>n){const b=t.shape.map(T=>T);b[t.shape.length-1]=e-n,r=he([t,vt(b)],t.shape.length-1),n=e}else r=t;const a=Te(r),o=I(Ke(r,a),[s,n]),i=ls(o),u=Math.floor(n/2)+1,c=jt(i),h=vn(i),l=Mt(c,[u,n-u],c.shape.length-1),f=Mt(h,[u,n-u],h.shape.length-1),m=r.shape.slice();return m[r.shape.length-1]=u,I(Ke(l[0],f[0]),m)}const hs=w({rfft_:Qb});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function n0(t,e=0){const n=rn(t,"tensors","stack","string_or_numeric");g(n.length>=1,()=>"Pass at least one tensor to tf.stack"),n.length>0&&g(e<=n[0].rank,()=>"Axis must be <= rank of the tensor");const s=n,r={axis:e};return N.runKernel(Qi,s,r)}const je=w({stack_:n0});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function r0(t,e,n,s,r=0,a=0,o=0,i=0,u=0){const h={x:d(t,"x","stridedSlice","string_or_numeric")},l={begin:e,end:n,strides:s,beginMask:r,endMask:a,ellipsisMask:o,newAxisMask:i,shrinkAxisMask:u};return N.runKernel(ju,h,l)}const Eh=w({stridedSlice_:r0});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function g0(t,e,n,s,r=!0){const a=d(t,"v","movingAverage"),o=d(e,"x","movingAverage"),i=d(n,"decay","movingAverage");pc(a,o),g(Re(a.shape,o.shape),()=>"Shape mismatch in v and x");const u=M(1),c=j(u,i);let h=D(j(o,a),c);if(r){g(s!=null,()=>"When using zeroDebias: true, step is required.");const l=d(s,"step","movingAverage");h=Z(h,j(u,Bt(i,l)))}return P(a,h)}const zh=w({movingAverage_:g0});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function w0(t,e,n,s=0){$e(n);const r=d(t,"sparseIndices","sparseToDense","int32"),a=d(e,"sparseValues","sparseToDense","string_or_numeric"),o=d(s,"defaultValue","sparseToDense",a.dtype);b0(r,a,n,o);const i={sparseIndices:r,sparseValues:a,defaultValue:o},u={outputShape:n};return N.runKernel(Bu,i,u)}const jh=w({sparseToDense_:w0});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function T0(t,e,n,s){const r=d(t,"x","dropout");if(g(r.dtype==="float32",()=>`x has to be a floating point tensor since it's going to be scaled, but got a ${r.dtype} tensor instead.`),g(e>=0&&e<1,()=>`rate must be a float in the range [0, 1), but got ${e}.`),e===0)return t instanceof ne?r.clone():r;const a=S0(r,n),o=1-e,i=Z(Dr(P(cs(a,0,1,"float32",s),o)),o);return D(r,i)}const Wh=w({dropout_:T0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function R0({a:t,b:e,transposeA:n=!1,transposeB:s=!1,bias:r,activation:a="linear",preluActivationWeights:o,leakyreluAlpha:i=.2}){if(bs(N.state.gradientDepth,a)===!1){let y=U(t,e,n,s);return r!=null&&(y=P(y,r)),ys(y,a,o,i)}let u=d(t,"a","fused matMul"),c=d(e,"b","fused matMul");[u,c]=ee(u,c);const h=n?u.shape[u.rank-2]:u.shape[u.rank-1],l=s?c.shape[c.rank-1]:c.shape[c.rank-2],f=n?u.shape[u.rank-1]:u.shape[u.rank-2],m=s?c.shape[c.rank-2]:c.shape[c.rank-1],b=u.shape.slice(0,-2),T=c.shape.slice(0,-2),S=G(b),$=G(T);g(h===l,()=>`Error in fused matMul: inner shapes (${h}) and (${l}) of Tensors with shapes ${u.shape} and ${c.shape} and transposeA=${n} and transposeB=${s} must match.`);const k=re(u.shape.slice(0,-2),c.shape.slice(0,-2)).concat([f,m]),_=n?I(u,[S,h,f]):I(u,[S,f,h]),A=s?I(c,[$,m,l]):I(c,[$,l,m]);let F;r!=null&&(F=d(r,"bias","fused matMul"),[F]=ee(F,u),re(k,F.shape));let L;o!=null&&(L=d(o,"prelu weights","fused matMul"));const R=(y,x)=>{const[C,z,V,W]=x,Y=ms(I(y,V.shape),V,a);let ae,te;if(!n&&!s?(ae=U(Y,z,!1,!0),te=U(C,Y,!0,!1)):!n&&s?(ae=U(Y,z,!1,!1),te=U(Y,C,!0,!1)):n&&!s?(ae=U(z,Y,!1,!0),te=U(C,Y,!1,!1)):(ae=U(z,Y,!0,!0),te=U(Y,C,!0,!0)),r!=null){const se=gs(W,Y);return[ae,te,se]}else return[ae,te]},v={a:_,b:A,bias:F,preluActivationWeights:L},E={transposeA:n,transposeB:s,activation:a,leakyreluAlpha:i};return r==null?Ve((x,C,z)=>{const V=N.runKernel(As,v,E);return z([x,C,V]),{value:I(V,k),gradFunc:R}})(_,A):Ve((x,C,z,V)=>{const W=N.runKernel(As,v,E);return V([x,C,W,z]),{value:I(W,k),gradFunc:R}})(_,A,F)}const C0=w({fusedMatMul_:R0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function V0(t,e,n,s,r=Gh){s==null&&(s=aa(e));const a=Hh(t,e,n),o=D(a,r(e));return hs(o,s)}const j0=w({stft_:V0});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */async function dw(t,e,n,s=.5,r=Number.NEGATIVE_INFINITY,a=!1){const o=d(t,"boxes","nonMaxSuppressionAsync"),i=d(e,"scores","nonMaxSuppressionAsync"),u=Gt(o,i,n,s,r,null),c=u.maxOutputSize,h=u.iouThreshold,l=u.scoreThreshold,[f,m]=await Promise.all([o.data(),i.data()]),{selectedIndices:b,validOutputs:T}=Xh(f,m,c,h,l,a);return o!==t&&o.dispose(),i!==e&&i.dispose(),{selectedIndices:ve(b,"int32"),validOutputs:M(T,"int32")}}const mw=dw;/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _w(t){let e;if(Array.isArray(t)){e=!1,g(t!=null&&t.length>0,()=>"Gram-Schmidt process: input must not be null, undefined, or empty");const r=t[0].shape[0];for(let a=1;a<t.length;++a)g(t[a].shape[0]===r,()=>`Gram-Schmidt: Non-unique lengths found in the input vectors: (${t[a].shape[0]} vs. ${r})`)}else e=!0,t=Mt(t,t.shape[0],0).map(r=>ps(r,[0]));g(t.length<=t[0].shape[0],()=>`Gram-Schmidt: Number of vectors (${t.length}) exceeds number of dimensions (${t[0].shape[0]}).`);const n=[],s=t;for(let r=0;r<t.length;++r)n.push(N.tidy(()=>{let a=s[r];if(r>0)for(let o=0;o<r;++o){const i=D(X(D(n[o],a)),n[o]);a=j(a,i)}return Z(a,$n(a,"euclidean"))}));return e?je(n,0):n}const Iw=w({gramSchmidt_:_w});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xw(t,e=!1){if(g(t.rank>=2,()=>`qr() requires input tensor to have a rank >= 2, but got rank ${t.rank}`),t.rank===2)return Pa(t,e);{const n=t.shape.slice(0,t.shape.length-2).reduce((u,c)=>u*c),s=lt(I(t,[n,t.shape[t.shape.length-2],t.shape[t.shape.length-1]]),0),r=[],a=[];s.forEach(u=>{const[c,h]=Pa(u,e);r.push(c),a.push(h)});const o=I(je(r,0),t.shape),i=I(je(a,0),t.shape);return[o,i]}}function Pa(t,e=!1){return N.tidy(()=>{g(t.shape.length===2,()=>`qr2d() requires a 2D Tensor, but got a ${t.shape.length}D Tensor.`);const n=t.shape[0],s=t.shape[1];let r=Or(n),a=Ge(t);const o=Rt([[1]],[1,1]);let i=Ge(o);const u=n>=s?s:n;for(let c=0;c<u;++c){const h=a,l=i,f=r;[i,a,r]=N.tidy(()=>{const m=H(a,[c,c],[n-c,1]),b=$n(m),T=H(a,[c,c],[1,1]),S=He(En(T,0),Rt([[-1]]),Rt([[1]])),$=j(T,D(S,b)),O=Z(m,$);O.shape[0]===1?i=Ge(o):i=he([o,H(O,[1,0],[O.shape[0]-1,O.shape[1]])],0);const k=Fe(Z(U(S,$),b)),_=H(a,[c,0],[n-c,s]),A=D(k,i),F=fn(i);if(c===0)a=j(_,U(A,U(F,_)));else{const v=j(_,U(A,U(F,_)));a=he([H(a,[0,0],[c,s]),v],0)}const L=fn(A),R=H(r,[0,c],[n,r.shape[1]-c]);if(c===0)r=j(R,U(U(R,i),L));else{const v=j(R,U(U(R,i),L));r=he([H(r,[0,0],[n,c]),v],1)}return[i,a,r]}),me([h,l,f])}return!e&&n>s&&(r=H(r,[0,0],[n,s]),a=H(a,[0,0],[s,s])),[r,a]})}const Aw=w({qr_:xw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Dw(t,e,n,s=de.SUM_BY_NONZERO_WEIGHTS){const r=d(t,"labels","absoluteDifference"),a=d(e,"predictions","absoluteDifference");let o=null;n!=null&&(o=d(n,"weights","absoluteDifference")),ge(r.shape,a.shape,"Error in absoluteDifference: ");const i=Se(j(r,a));return Ze(i,o,s)}const Fw=w({absoluteDifference_:Dw});function Rw(t,e,n,s,r=de.SUM_BY_NONZERO_WEIGHTS){const a=d(t,"labels","cosineDistance"),o=d(e,"predictions","cosineDistance");let i=null;s!=null&&(i=d(s,"weights","cosineDistance")),ge(a.shape,o.shape,"Error in cosineDistance: ");const u=M(1),c=j(u,X(D(a,o),n,!0));return Ze(c,i,r)}const Cw=w({cosineDistance_:Rw});function Lw(t,e,n,s=de.SUM_BY_NONZERO_WEIGHTS){let r=d(t,"labels","hingeLoss");const a=d(e,"predictions","hingeLoss");let o=null;n!=null&&(o=d(n,"weights","hingeLoss")),ge(r.shape,a.shape,"Error in hingeLoss: ");const i=M(1);r=j(D(M(2),r),i);const u=kn(j(i,D(r,a)));return Ze(u,o,s)}const Pw=w({hingeLoss_:Lw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Bw(t,e,n,s=1,r=de.SUM_BY_NONZERO_WEIGHTS){const a=d(t,"labels","huberLoss"),o=d(e,"predictions","huberLoss");let i=null;n!=null&&(i=d(n,"weights","huberLoss")),ge(a.shape,o.shape,"Error in huberLoss: ");const u=M(s),c=Se(j(o,a)),h=hn(c,u),l=j(c,h),f=P(D(M(.5),Ie(h)),D(u,l));return Ze(f,i,r)}const zw=w({huberLoss_:Bw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Vw(t,e,n,s=1e-7,r=de.SUM_BY_NONZERO_WEIGHTS){const a=d(t,"labels","logLoss"),o=d(e,"predictions","logLoss");let i=null;n!=null&&(i=d(n,"weights","logLoss")),ge(a.shape,o.shape,"Error in logLoss: ");const u=M(1),c=M(s),h=Fe(D(a,zt(P(o,c)))),l=D(j(u,a),zt(P(j(u,o),c))),f=j(h,l);return Ze(f,i,r)}const jw=w({logLoss_:Vw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mw(t,e,n,s=de.SUM_BY_NONZERO_WEIGHTS){const r=d(t,"labels","meanSquaredError"),a=d(e,"predictions","meanSquaredError");let o=null;n!=null&&(o=d(n,"weights","meanSquaredError")),ge(r.shape,a.shape,"Error in meanSquaredError: ");const i=ea(r,a);return Ze(i,o,s)}const Ww=w({meanSquaredError_:Mw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Uw(t,e){const n=d(t,"labels","sigmoidCrossEntropyWithLogits"),s=d(e,"logits","sigmoidCrossEntropyWithLogits");ge(n.shape,s.shape,"Error in sigmoidCrossEntropyWithLogits: ");const r=kn(s),a=D(s,n),o=Lr(it(Fe(Se(s))));return P(j(r,a),o)}function qw(t,e,n,s=0,r=de.SUM_BY_NONZERO_WEIGHTS){let a=d(t,"multiClassLabels","sigmoidCrossEntropy");const o=d(e,"logits","sigmoidCrossEntropy");let i=null;if(n!=null&&(i=d(n,"weights","sigmoidCrossEntropy")),ge(a.shape,o.shape,"Error in sigmoidCrossEntropy: "),s>0){const c=M(s),h=M(1),l=M(.5);a=P(D(a,j(h,c)),D(l,c))}const u=Uw(a,o);return Ze(u,i,r)}const Gw=w({sigmoidCrossEntropy_:qw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Hw(t,e,n=-1){if(n===-1&&(n=e.rank-1),n!==e.rank-1)throw Error(`Softmax cross entropy along a non-last dimension is not yet supported. Labels / logits was rank ${e.rank} and dim was ${n}`);return Ve((r,a,o)=>{const u=Br(a,[n],!0),c=j(J(a,"float32"),u);o([r,c]);const h=Fe(D(c,r));return{value:X(h,[n]),gradFunc:(m,b)=>{const[T,S]=b,$=Tn(m.shape,[n]);return[D(I(m,$),j(J(T,"float32"),it(S))),D(I(m,$),j(it(S),J(T,"float32")))]}}})(t,e)}function Kw(t,e,n,s=0,r=de.SUM_BY_NONZERO_WEIGHTS){let a=d(t,"onehotLabels","softmaxCrossEntropy");const o=d(e,"logits","softmaxCrossEntropy");let i=null;if(n!=null&&(i=d(n,"weights","softmaxCrossEntropy")),ge(a.shape,o.shape,"Error in softmaxCrossEntropy: "),s>0){const c=M(s),h=M(1),l=M(a.shape[1]);a=P(D(a,j(h,c)),Z(c,l))}const u=Hw(a,o);return Ze(u,i,r)}const Xw=w({softmaxCrossEntropy_:Kw});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function o1(t,e,n=!0){const s=d(t,"input","stringSplit","string"),r=d(e,"delimiter","stringSplit","string");if(s.rank!==1)throw new Error(`Input should be Tensor1D but received shape ${s.shape}`);if(r.rank!==0)throw new Error(`Delimiter should be a scalar but received shape ${r.shape}`);const a={skipEmpty:n},o={input:s,delimiter:r},i=N.runKernel(Wu,o,a);return{indices:i[0],values:i[1],shape:i[2]}}const i1=w({stringSplit_:o1});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Jh={fft:ls,ifft:pn,rfft:hs,irfft:Qr},Yh={hammingWindow:P0,hannWindow:Gh,frame:Hh,stft:j0},Qh={flipLeftRight:q0,grayscaleToRGB:H0,resizeNearestNeighbor:ww,resizeBilinear:yw,rgbToGrayscale:X0,rotateWithOffset:J0,cropAndResize:W0,nonMaxSuppression:Q0,nonMaxSuppressionAsync:iw,nonMaxSuppressionWithScore:cw,nonMaxSuppressionWithScoreAsync:hw,nonMaxSuppressionPadded:fw,nonMaxSuppressionPaddedAsync:mw,threshold:Tw,transform:Ew},ep={bandPart:kw,gramSchmidt:Iw,qr:Aw},tp={absoluteDifference:Fw,computeWeightedLoss:Ze,cosineDistance:Cw,hingeLoss:Pw,huberLoss:zw,logLoss:jw,meanSquaredError:Ww,sigmoidCrossEntropy:Gw,softmaxCrossEntropy:Xw},np={sparseFillEmptyRows:Jw,sparseReshape:Qw,sparseSegmentMean:t1,sparseSegmentSum:s1},sp={stringNGrams:a1,stringSplit:i1,stringToHashBucketFast:c1,staticRegexReplace:h1};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Ga{static get Instance(){return this._instance||(this._instance=new this)}constructor(){const e=[fS,mS,yS,wS,SS,$S,vS,_S,xS,OS,FS,CS,PS,zS,jS,WS,qS,HS,XS],n=[].concat(...e.map(s=>s.json));this.opMappers=n.reduce((s,r)=>(s[r.tfOpName]=r,s),{})}transformGraph(e,n={}){const s=e.node,r=[],a=[],o=[],i=s.reduce((T,S)=>(T[S.name]=this.mapNode(S),S.op.startsWith("Placeholder")?r.push(T[S.name]):S.op==="Const"?a.push(T[S.name]):(S.input==null||S.input.length===0)&&o.push(T[S.name]),T),{});let u=[];const c=[];let h={},l={};n!=null&&(h=this.mapSignatureEntries(n.inputs),l=this.mapSignatureEntries(n.outputs));const f=Object.keys(i);f.forEach(T=>{const S=i[T];S.inputNames.forEach(($,O)=>{const[k,,_]=We($),A=i[k];if(A.outputs!=null){const F=A.outputs.indexOf(_);if(F!==-1){const L=`${k}:${F}`;S.inputNames[O]=L}}S.inputs.push(A),A.children.push(S)})}),Object.keys(l).length===0?f.forEach(T=>{const S=i[T];S.children.length===0&&c.push(S)}):Object.keys(l).forEach(T=>{const[S]=We(T),$=i[S];$!=null&&($.signatureKey=l[T],c.push($))}),Object.keys(h).length>0?Object.keys(h).forEach(T=>{const[S]=We(T),$=i[S];$&&($.signatureKey=h[T],u.push($))}):u=r;let m={};e.library!=null&&e.library.function!=null&&(m=e.library.function.reduce((T,S)=>(T[S.signature.name]=this.mapFunction(S),T),{}));const b={nodes:i,inputs:u,outputs:c,weights:a,placeholders:r,signature:n,functions:m};return o.length>0&&(b.initNodes=o),b}mapSignatureEntries(e){return Object.keys(e||{}).reduce((n,s)=>(n[e[s].name]=s,n),{})}mapNode(e){const n=$p(e.op)||this.opMappers[e.op]||{};e.attr==null&&(e.attr={});const s={name:e.name,op:e.op,category:n.category,inputNames:(e.input||[]).map(r=>r.startsWith("^")?r.slice(1):r),inputs:[],children:[],inputParams:{},attrParams:{},rawAttrs:e.attr,outputs:n.outputs};return n.inputs!=null&&(s.inputParams=n.inputs.reduce((r,a)=>(r[a.name]={type:a.type,inputIndexStart:a.start,inputIndexEnd:a.end},r),{})),n.attrs!=null&&(s.attrParams=n.attrs.reduce((r,a)=>{const o=a.type;let i;switch(a.type){case"string":i=Xs(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=Xs(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"string[]":i=nr(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=nr(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"number":i=Js(e.attr,a.tfName,a.defaultValue||0),i===void 0&&a.tfDeprecatedName&&(i=Js(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"number[]":i=tr(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=tr(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"bool":i=Zs(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=Zs(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"bool[]":i=rr(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=rr(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"shape":i=er(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=er(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"shape[]":i=sr(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=sr(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"dtype":i=Ys(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=Ys(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"dtype[]":i=Qs(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=Qs(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"func":i=Ha(e.attr,a.tfName,a.defaultValue),i===void 0&&a.tfDeprecatedName&&(i=Ha(e.attr,a.tfDeprecatedName,a.defaultValue));break;case"tensor":case"tensors":break;default:throw new Error(`Unsupported param type: ${a.type} for op: ${e.op}`)}return r[a.name]={value:i,type:o},r},{})),s}mapFunction(e){const n=e.nodeDef,s=[],r=[];let a={};n!=null&&(a=n.reduce((l,f)=>(l[f.name]=this.mapNode(f),f.op==="Const"&&r.push(l[f.name]),l),{}));const o=[],i=[];e.signature.inputArg.forEach(l=>{const[f]=We(l.name),m={name:f,op:"Placeholder",inputs:[],inputNames:[],category:"graph",inputParams:{},attrParams:{dtype:{value:ba(l.type),type:"dtype"}},children:[]};m.signatureKey=l.name,o.push(m),a[f]=m}),Object.keys(a).forEach(l=>{const f=a[l];f.inputNames.forEach((m,b)=>{const[T,,S]=We(m),$=a[T];if($.outputs!=null){const O=$.outputs.indexOf(S);if(O!==-1){const k=`${T}:${O}`;f.inputNames[b]=k}}f.inputs.push($),$.children.push(f)})});const c=e.ret;e.signature.outputArg.forEach(l=>{const[f,m]=We(c[l.name]),b=a[f];b!=null&&(b.defaultOutput=m,i.push(b))});const h=this.mapArgsToSignature(e);return{nodes:a,inputs:o,outputs:i,weights:r,placeholders:s,signature:h}}mapArgsToSignature(e){return{methodName:e.signature.name,inputs:e.signature.inputArg.reduce((n,s)=>(n[s.name]=this.mapArgToTensorInfo(s),n),{}),outputs:e.signature.outputArg.reduce((n,s)=>(n[s.name]=this.mapArgToTensorInfo(s,e.ret),n),{})}}mapArgToTensorInfo(e,n){let s=e.name;return n!=null&&(s=n[s]),{name:s,dtype:e.type}}}function ZS(t){const e=B().global;if(typeof e.atob<"u")return e.atob(t);if(typeof Buffer<"u")return new Buffer(t,"base64").toString();throw new Error("Unable to decode base64 in this environment. Missing built-in atob() or Buffer()")}function Ep(t,e){const n=Array.isArray(t)?String.fromCharCode.apply(null,t):ZS(t);return e?n:n.toLowerCase()}function Xs(t,e,n,s=!1){const r=t[e];return r!=null?Ep(r.s,s):n}function Zs(t,e,n){const s=t[e];return s?s.b:n}function Js(t,e,n){const s=t[e]||{},r=s.i!=null?s.i:s.f!=null?s.f:n;return typeof r=="number"?r:parseInt(r,10)}function ba(t){switch(typeof t=="string"&&(t=we[t]),t){case we.DT_FLOAT:case we.DT_HALF:return"float32";case we.DT_INT32:case we.DT_INT64:case we.DT_INT8:case we.DT_UINT8:return"int32";case we.DT_BOOL:return"bool";case we.DT_DOUBLE:return"float32";case we.DT_STRING:return"string";case we.DT_COMPLEX64:case we.DT_COMPLEX128:return"complex64";default:return null}}function Ha(t,e,n){const s=t[e];return s&&s.func?s.func.name:n}function Ys(t,e,n){const s=t[e];return s&&s.type?ba(s.type):n}function Qs(t,e,n){const s=t[e];return s&&s.list&&s.list.type?s.list.type.map(r=>ba(r)):n}function vp(t){if(!t.unknownRank)return t.dim!=null?t.dim.map(e=>typeof e.size=="number"?e.size:parseInt(e.size,10)):[]}function er(t,e,n){const s=t[e];return s&&s.shape?vp(s.shape):n}function tr(t,e,n){const s=t[e];return s?((s.list.f&&s.list.f.length?s.list.f:s.list.i)||[]).map(r=>typeof r=="number"?r:parseInt(r,10)):n}function nr(t,e,n,s=!1){const r=t[e];return r&&r.list&&r.list.s?r.list.s.map(a=>Ep(a,s)):n}function sr(t,e,n){const s=t[e];return s&&s.list&&s.list.shape?s.list.shape.map(r=>vp(r)):n}function rr(t,e,n){const s=t[e];return s&&s.list&&s.list.b?s.list.b:n}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const le=Object.freeze(Object.defineProperty({__proto__:null,OP_SCOPE_SUFFIX:yr,abs:Se,acos:Ac,acosh:Oc,add:P,addN:Dc,all:Fc,any:Rc,argMax:Cc,argMin:Lc,asin:Pc,asinh:Bc,atan:zc,atan2:Vc,atanh:jc,avgPool:Er,avgPool3d:qc,basicLSTMCell:Gc,batchNorm:Nn,batchNorm2d:Hc,batchNorm3d:Kc,batchNorm4d:Xc,batchToSpaceND:vr,bincount:kr,bitwiseAnd:Zc,booleanMaskAsync:Bh,broadcastArgs:Jc,broadcastTo:Yt,buffer:Be,cast:J,ceil:Yc,clipByValue:Qc,clone:Ge,complex:Ke,concat:he,concat1d:el,concat2d:tl,concat3d:nl,concat4d:sl,conv1d:rl,conv2d:Sn,conv2dTranspose:ol,conv3d:il,conv3dTranspose:ul,cos:cl,cosh:ll,cosineWindow:ds,cumprod:hl,cumsum:pl,denseBincount:fl,depthToSpace:dl,depthwiseConv2d:as,diag:ml,dilation2d:gl,div:Z,divNoNan:bl,dot:wl,dropout:Wh,einsum:mt,elu:xr,enclosingPowerOfTwo:aa,ensureShape:Nl,equal:Ir,erf:Sl,euclideanNorm:El,exp:it,expandDims:Me,expm1:vl,eye:Or,fft:ls,fill:Ut,floor:Dr,floorDiv:Tr,fused:qh,gather:Fr,gatherND:Mh,greater:En,greaterEqual:Rr,ifft:pn,imag:vn,image:Qh,inTopKAsync:Uh,irfft:Qr,isFinite:kl,isInf:_l,isNaN:Il,leakyRelu:Cr,less:Jn,lessEqual:os,linalg:ep,linspace:xl,localResponseNormalization:Al,log:zt,log1p:Lr,logSigmoid:Dl,logSoftmax:Fl,logSumExp:Br,logicalAnd:cn,logicalNot:zr,logicalOr:Vr,logicalXor:Rl,losses:tp,lowerBound:Cl,matMul:U,max:Nt,maxPool:jr,maxPool3d:Ll,maxPoolWithArgmax:Pl,maximum:Mr,mean:ln,meshgrid:Bl,min:Zn,minimum:hn,mirrorPad:zl,mod:Vl,moments:jl,movingAverage:zh,mul:D,multiRNNCell:Ml,multinomial:Wl,neg:Fe,norm:$n,notEqual:Wr,oneHot:Yn,ones:tt,onesLike:Ul,op:w,outerProduct:ql,pad:qt,pad1d:Gl,pad2d:Hl,pad3d:Kl,pad4d:Xl,pool:Zl,pow:Bt,prelu:qr,print:Sr,prod:Jl,raggedGather:Yl,raggedRange:Ql,raggedTensorToTensor:eh,rand:th,randomGamma:rh,randomNormal:Zr,randomStandardNormal:ah,randomUniform:cs,randomUniformInt:oh,range:Vt,real:jt,reciprocal:ih,relu:kn,relu6:Jr,reshape:I,reverse:ut,reverse1d:uh,reverse2d:ch,reverse3d:lh,reverse4d:hh,rfft:hs,round:Yr,rsqrt:ph,scalar:M,scatterND:Vh,searchSorted:us,selu:fh,separableConv2d:dh,setdiff1dAsync:mh,sigmoid:wt,sign:gh,signal:Yh,sin:yh,sinh:bh,slice:H,slice1d:wh,slice2d:Nh,slice3d:Sh,slice4d:Th,softmax:$h,softplus:Pr,spaceToBatchND:Ur,sparse:np,sparseToDense:jh,spectral:Jh,split:Mt,sqrt:ze,square:Ie,squaredDifference:ea,squeeze:ps,stack:je,step:ta,stridedSlice:Eh,string:sp,sub:j,sum:X,tan:vh,tanh:Xn,tensor:De,tensor1d:ve,tensor2d:Rt,tensor3d:na,tensor4d:kh,tensor5d:_h,tensor6d:Ih,tensorScatterUpdate:Ah,tile:Ft,topk:Oh,transpose:fn,truncatedNormal:Dh,unique:Fh,unsortedSegmentSum:Rh,unstack:lt,upperBound:Ch,variable:Lh,where:He,whereAsync:ra,zeros:vt,zerosLike:Te},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
